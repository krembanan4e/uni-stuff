//Марија и нејзините другарки сакаат да одат во кино и купуваат билети. Иницијалната цена на еден билет за сите филмови е 200 денари, но доколку филмот е комедија се доплаќа 20, за акција се доплаќа 40, за романса 30.
...
int main() {
    ...
    //int comedy = 220, action = 240, romance = 230, voda = 80, Fanta = 100, CocaCola = 100, Sprite = 100, IceTea = 120, S = 100, M = 150, L = 200, cena = 0;
